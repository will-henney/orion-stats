...
%DIF ADD ms-resubmit-will.tex   Sun Aug 10 23:42:44 2014
\pdfminorversion=4
\usepackage{bm}
\usepackage{graphicx}
%DIF 5a5
...
include self gravity. However, on the relatively short timescales of
...
Figure~\ref{fig:veldisp}. \DIFaddbegin \DIFadd{The flattening-off of the power spectra
corresponds to the time at which the global expansion ceases to be
important for the internal dynamics (see Fig.~\ref{fig:veldisp}).
}\DIFaddend 
...
}\DIFdelend \DIFaddbegin \DIFadd{Results for representative
evolutionary times are shown in Figures~\ref{fig:sfunc} to
\ref{fig:sfuncyz} of Appendix~\ref{app:sf}, where power law fits to
the slope (}\mSF\DIFadd{) of the structure function are carried out for the
inertial range of scales.
}\DIFaddend 

\DIFdelbegin \DIFdel{If turbulence is present, }\DIFdelend \DIFaddbegin \DIFadd{In Figure~\ref{fig:sftrends} we show the evolution of }\mSF{} \DIFadd{with time
for the different lines and for }\DIFaddend the \DIFdelbegin \DIFdel{second-order structure function should exhibit an
...
having greater than 6.6\% of the peak intensity.
We then took the
...
%DIFDELCMD < %%%
\DIFdel{An alternative criterion for the upper limit was used by \mbox{%DIFAUXCMD
\citet
{2011MNRAS.413..721L}
}%DIFAUXCMD
...
%DIFDELCMD < %%%
\DIFdel{In Table~\ref{tab:sfunc} we summarize the results for the power-law
...
the $xz$-plane}\DIFdelend \DIFaddbegin \DIFadd{three principal viewing directions
...
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \includegraphics[width=0.8\textwidth]{vca-time-trends-all}
\DIFaddendFL \caption{\DIFdelbeginFL \DIFdelFL{Power spectra }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{ Evolution }\DIFaddendFL of \DIFdelbeginFL \DIFdelFL{the }\DIFdelendFL velocity \DIFaddbeginFL \DIFaddFL{channel power-law index as a function
  of time for thick }\DIFaddendFL channels \DIFaddbeginFL \DIFaddFL{(}\gammaVCAvthick\DIFaddFL{; crosses) and thin
  channels (}\gammaVCAthin\DIFaddFL{; filled circles)}\DIFaddendFL .  From top to bottom:
  H$\alpha$, \DIFdelbeginFL %DIFDELCMD < \oiii%%%
\DIFdelendFL \DIFaddbeginFL \oiii{} \DIFaddendFL $\lambda 5007$, \DIFdelbeginFL %DIFDELCMD < \nii%%%
\DIFdelendFL \DIFaddbeginFL \nii{} \DIFaddendFL $\lambda 6584$, \DIFdelbeginFL %DIFDELCMD < \sii%%%
\DIFdelendFL \DIFaddbeginFL \sii{}
  \DIFaddendFL $\lambda 6716$. From left to right: \DIFdelbeginFL \DIFdelFL{150}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{line of sight along the $z$}\DIFaddendFL , \DIFdelbeginFL \DIFdelFL{000, 200,000, 250,000 }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{$x$
  }\DIFaddendFL and \DIFdelbeginFL \DIFdelFL{300}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{$y$ axes}\DIFaddendFL , \DIFdelbeginFL \DIFdelFL{000~years}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{respectively}\DIFaddendFL .  \DIFdelbeginFL \DIFdelFL{The upper panel in each figure are for velocities
  without thermal }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Thermal }\DIFaddendFL broadening \DIFdelbeginFL \DIFdelFL{, the lower panel is the case with thermal
  ...
  least-squares fit to the data points for the thin slice between limits described }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{was included }\DIFaddendFL in \DIFdelbeginFL \DIFdelFL{the
text represented by the grey rectangle}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{all
  cases}\DIFaddendFL .  \DIFdelbeginFL \DIFdelFL{The solid line is the least-squares fit to
the data points for the thick slice.}\DIFdelendFL }
\DIFdelbeginFL %DIFDELCMD < \label{fig:vca}
%DIFDELCMD < %%%
\DIFdelendFL \DIFaddbeginFL \label{fig:vcatrends}
\DIFaddendFL \end{figure*}
...
%DIFDELCMD < \caption{%
{%DIFAUXCMD
\DIFdel{Power-law indices for the velocity channel analysis.}}
%DIFAUXCMD
...
\DIFdel{Time }%DIFDELCMD < & %%%
\DIFdel{Plane }%DIFDELCMD < & %%%
\DIFdel{$\gamma_{\mathrm{vthick}}$ }%DIFDELCMD < & %%%
\DIFdel{$\gamma_{\mathrm{thin}}$}%DIFDELCMD < &  %%%
\DIFdel{$\gamma_{\mathrm thin}$}%DIFDELCMD < \\
%DIFDELCMD < & %%%
\DIFdel{(yrs) }%DIFDELCMD < &  & & %%%
\DIFdel{No Broadening }%DIFDELCMD < & %%%
\DIFdel{Broadening }%DIFDELCMD < \\
%DIFDELCMD < \hline
%DIFDELCMD < %%%
\DIFdel{H$\alpha$ }%DIFDELCMD < & %%%
\DIFdel{150,000  }%DIFDELCMD < &%%%
\DIFdel{$xy$}%DIFDELCMD < & %%%
\DIFdel{$-2.65$ }%DIFDELCMD < & %%%
\DIFdel{$-2.54$ }%DIFDELCMD < & %%%
\DIFdel{$-2.67$ }%DIFDELCMD < \\
%DIFDELCMD <                   &                &%%%
\DIFdel{$xz$}%DIFDELCMD < & %%%
\DIFdel{$-2.52$ }%DIFDELCMD < & %%%
\DIFdel{$-2.49$ }%DIFDELCMD < & %%%
\DIFdel{$-2.63$ }%DIFDELCMD < \\
%DIFDELCMD <                   &                &%%%
\DIFdel{$yz$}%DIFDELCMD < & %%%
\DIFdel{$-2.66$ }%DIFDELCMD < & %%%
\DIFdel{$-2.40$ }%DIFDELCMD < & %%%
...
\DIFdel{$-2.58$}%DIFDELCMD < \\
%DIFDELCMD <                   &                &%%%
\DIFdel{$xz$}%DIFDELCMD < & %%%
\DIFdel{$-2.55$ }%DIFDELCMD < & %%%
\DIFdel{$-2.35$ }%DIFDELCMD < & %%%
\DIFdel{$-2.51$ }%DIFDELCMD < \\
%DIFDELCMD <                   &                &%%%
\DIFdel{$yz$}%DIFDELCMD < & %%%
\DIFdel{$-2.49$ }%DIFDELCMD < & %%%
\DIFdel{$-2.26$ }%DIFDELCMD < &  %%%
\DIFdel{$-2.42$ }%DIFDELCMD < \\
%DIFDELCMD <                   & %%%
\DIFdel{250,000  }%DIFDELCMD < &%%%
\DIFdel{$xy$}%DIFDELCMD < & %%%
\DIFdel{$-2.61$ }%DIFDELCMD < & %%%
\DIFdel{$-2.31$ }%DIFDELCMD < & %%%
\DIFdel{$-2.48$}%DIFDELCMD < \\
%DIFDELCMD <                   &                &%%%
\DIFdel{$xz$}%DIFDELCMD < & %%%
\DIFdel{$-2.60$ }%DIFDELCMD < & %%%
\DIFdel{$-2.29$ }%DIFDELCMD < & %%%
...
\DIFdel{$-2.23$ }%DIFDELCMD < & %%%
\DIFdel{$-2.37$}%DIFDELCMD < \\
%DIFDELCMD <                   &                &%%%
\DIFdel{$xz$}%DIFDELCMD < & %%%
\DIFdel{$-2.53$ }%DIFDELCMD < & %%%
\DIFdel{$-2.23$ }%DIFDELCMD < & %%%
...
\DIFdel{$-2.90$ }%DIFDELCMD < &  %%%
\DIFdel{$-3.15$ }%DIFDELCMD < \\
%DIFDELCMD < %%%
\DIFdel{$\lambda$5007 }%DIFDELCMD < &        &%%%
\DIFdel{$xz$}%DIFDELCMD < & %%%
\DIFdel{$-3.14$ }%DIFDELCMD < & %%%
\DIFdel{$-2.73$ }%DIFDELCMD < &  %%%
\DIFdel{$-3.01$ }%DIFDELCMD < \\
%DIFDELCMD <                   &                &%%%
\DIFdel{$yz$}%DIFDELCMD < & %%%
\DIFdel{$-3.42$ }%DIFDELCMD < & %%%
\DIFdel{$-2.51$ }%DIFDELCMD < &  %%%
\DIFdel{$-2.71$ }%DIFDELCMD < \\
%DIFDELCMD <                   & %%%
\DIFdel{200,000  }%DIFDELCMD < &%%%
\DIFdel{$xy$}%DIFDELCMD < & %%%
\DIFdel{$-3.32$ }%DIFDELCMD < & %%%
\DIFdel{$-2.62$ }%DIFDELCMD < & %%%
\DIFdel{$-2.84$ }%DIFDELCMD < \\
%DIFDELCMD <                   &                &%%%
\DIFdel{$xz$}%DIFDELCMD < & %%%
\DIFdel{$-3.18$ }%DIFDELCMD < & %%%
\DIFdel{$-2.55$ }%DIFDELCMD < & %%%
\DIFdel{$-2.76$ }%DIFDELCMD < \\
%DIFDELCMD <                   &                &%%%
\DIFdel{$yz$}%DIFDELCMD < & %%%
\DIFdel{$-3.26$ }%DIFDELCMD < & %%%
\DIFdel{$-2.51$ }%DIFDELCMD < & %%%
\DIFdel{$-2.69$ }%DIFDELCMD < \\
%DIFDELCMD <                   & %%%
\DIFdel{250,000  }%DIFDELCMD < &%%%
\DIFdel{$xy$}%DIFDELCMD < & %%%
\DIFdel{$-3.37$ }%DIFDELCMD < & %%%
\DIFdel{$-2.57$ }%DIFDELCMD < & %%%
\DIFdel{$-2.78$ }%DIFDELCMD < \\
%DIFDELCMD <                   &                &%%%
\DIFdel{$xz$}%DIFDELCMD < & %%%
\DIFdel{$-3.31$ }%DIFDELCMD < & %%%
\DIFdel{$-2.48$ }%DIFDELCMD < & %%%
\DIFdel{$-2.69$ }%DIFDELCMD < \\
%DIFDELCMD <                   &                &%%%
\DIFdel{$yz$}%DIFDELCMD < & %%%
\DIFdel{$-3.34$ }%DIFDELCMD < & %%%
\DIFdel{$-2.45$ }%DIFDELCMD < & %%%
\DIFdel{$-2.69$ }%DIFDELCMD < \\
%DIFDELCMD <                   & %%%
\DIFdel{300,000  }%DIFDELCMD < &%%%
\DIFdel{$xy$}%DIFDELCMD < & %%%
\DIFdel{$-3.38$ }%DIFDELCMD < & %%%
\DIFdel{$-2.46$ }%DIFDELCMD < & %%%
\DIFdel{$-2.69$ }%DIFDELCMD < \\
%DIFDELCMD <                   &                &%%%
\DIFdel{$xz$}%DIFDELCMD < & %%%
\DIFdel{$-3.39$ }%DIFDELCMD < & %%%
\DIFdel{$-2.46$ }%DIFDELCMD < & %%%
\DIFdel{$-2.68$ }%DIFDELCMD < \\
%DIFDELCMD <                   &                &%%%
\DIFdel{$yz$}%DIFDELCMD < & %%%
\DIFdel{$-3.43$ }%DIFDELCMD < & %%%
\DIFdel{$-2.58$ }%DIFDELCMD < & %%%
\DIFdel{$-2.79$ }%DIFDELCMD < \\
%DIFDELCMD < \hline
%DIFDELCMD < \nii{}           & %%%
\DIFdel{150,000  }%DIFDELCMD < &%%%
\DIFdel{$xy$}%DIFDELCMD < & %%%
...
\DIFdel{$-2.28$ }%DIFDELCMD < \\
%DIFDELCMD < %%%
\DIFdel{$\lambda$6584 }%DIFDELCMD < &        &%%%
\DIFdel{$xz$}%DIFDELCMD < & %%%
\DIFdel{$-2.38$ }%DIFDELCMD < & %%%
\DIFdel{$-2.05$ }%DIFDELCMD < & %%%
\DIFdel{$-2.20$ }%DIFDELCMD < \\
%DIFDELCMD <                   &                &%%%
\DIFdel{$yz$}%DIFDELCMD < & %%%
\DIFdel{$-2.42$ }%DIFDELCMD < & %%%
\DIFdel{$-2.16$ }%DIFDELCMD < & %%%
\DIFdel{$-2.30$ }%DIFDELCMD < \\
%DIFDELCMD <                  & %%%
\DIFdel{200,000 }%DIFDELCMD < &%%%
\DIFdel{$xy$}%DIFDELCMD < & %%%
\DIFdel{$-2.61$ }%DIFDELCMD < & %%%
\DIFdel{$-2.18$ }%DIFDELCMD < & %%%
\DIFdel{$-2.36$ }%DIFDELCMD < \\
%DIFDELCMD <                   &                &%%%
\DIFdel{$xz$}%DIFDELCMD < & %%%
\DIFdel{$-2.48$ }%DIFDELCMD < & %%%
\DIFdel{$-2.17$ }%DIFDELCMD < & %%%
\DIFdel{$-2.31$ }%DIFDELCMD < \\
%DIFDELCMD <                   &                &%%%
\DIFdel{$yz$}%DIFDELCMD < & %%%
\DIFdel{$-2.44$ }%DIFDELCMD < & %%%
\DIFdel{$-2.14$ }%DIFDELCMD < & %%%
\DIFdel{$-2.29$ }%DIFDELCMD < \\
%DIFDELCMD <                  & %%%
\DIFdel{250,000 }%DIFDELCMD < &%%%
\DIFdel{$xy$}%DIFDELCMD < & %%%
...
\DIFdel{$xy$}%DIFDELCMD < & %%%
\DIFdel{$-2.13$ }%DIFDELCMD < & %%%
\DIFdel{$-1.76$ }%DIFDELCMD < & %%%
\DIFdel{$-1.87$ }%DIFDELCMD < \\
%DIFDELCMD < %%%
\DIFdel{$\lambda$6716 }%DIFDELCMD < &        &%%%
\DIFdel{$xz$}%DIFDELCMD < & %%%
\DIFdel{$-1.96$ }%DIFDELCMD < & %%%
\DIFdel{$-1.61$ }%DIFDELCMD < & %%%
\DIFdel{$-1.69$ }%DIFDELCMD < \\
%DIFDELCMD <                   &                &%%%
\DIFdel{$yz$}%DIFDELCMD < & %%%
\DIFdel{$-2.11$ }%DIFDELCMD < & %%%
...
\DIFdel{$-1.82$ }%DIFDELCMD < & %%%
\DIFdel{$-1.89$ }%DIFDELCMD < \\
%DIFDELCMD <                   &                &%%%
\DIFdel{$xz$}%DIFDELCMD < & %%%
\DIFdel{$-1.82$ }%DIFDELCMD < & %%%
\DIFdel{$-1.69$ }%DIFDELCMD < & %%%
\DIFdel{$-1.74$ }%DIFDELCMD < \\
%DIFDELCMD <                   &                &%%%
\DIFdel{$yz$}%DIFDELCMD < & %%%
\DIFdel{$-2.04$ }%DIFDELCMD < & %%%
\DIFdel{$-1.75$ }%DIFDELCMD < & %%%
\DIFdel{$-1.86$ }%DIFDELCMD < \\
%DIFDELCMD <                  & %%%
\DIFdel{250,000  }%DIFDELCMD < &%%%
\DIFdel{$xy$}%DIFDELCMD < & %%%
\DIFdel{$-1.84$ }%DIFDELCMD < & %%%
\DIFdel{$-1.69$ }%DIFDELCMD < &  %%%
\DIFdel{$-1.76$ }%DIFDELCMD < \\
%DIFDELCMD <                   &                &%%%
\DIFdel{$xz$}%DIFDELCMD < & %%%
\DIFdel{$-2.19$ }%DIFDELCMD < & %%%
\DIFdel{$-1.96$ }%DIFDELCMD < & %%%
\DIFdel{$-2.02$ }%DIFDELCMD < \\
%DIFDELCMD <                   &                &%%%
\DIFdel{$yz$}%DIFDELCMD < & %%%
\DIFdel{$-1.97$ }%DIFDELCMD < & %%%
\DIFdel{$-1.76$ }%DIFDELCMD < & %%%
\DIFdel{$-1.80$ }%DIFDELCMD < \\
%DIFDELCMD <                  & %%%
\DIFdel{300,000  }%DIFDELCMD < &%%%
\DIFdel{$xy$}%DIFDELCMD < & %%%
\DIFdel{$-1.85$ }%DIFDELCMD < & %%%
\DIFdel{$-1.59$ }%DIFDELCMD < & %%%
\DIFdel{$-1.66$ }%DIFDELCMD < \\
%DIFDELCMD <                   &                &%%%
\DIFdel{$xz$}%DIFDELCMD < & %%%
\DIFdel{$-1.92$ }%DIFDELCMD < & %%%
\DIFdel{$-1.64$ }%DIFDELCMD < & %%%
\DIFdel{$-1.71$ }%DIFDELCMD < \\
%DIFDELCMD <                   &                &%%%
\DIFdel{$yz$}%DIFDELCMD < & %%%
\DIFdel{$-1.96$ }%DIFDELCMD < & %%%
\DIFdel{$-1.73$ }%DIFDELCMD < & %%%
\DIFdel{$-1.78$ }%DIFDELCMD < \\
%DIFDELCMD < \hline
%DIFDELCMD < \end{tabular}
%DIFDELCMD < \end{table*}
%DIFDELCMD < 
...
%DIFDELCMD < %%%
\DIFdel{Figure~\ref{fig:vca} shows the power spectra resulting from the
...
vary with the addition of thermal broadening.  The slopes of these fits, $\gamma_{\mathrm{vthick}}$ and $\gamma_{\mathrm{thin}}$, are given in Table~\ref{tab:vca}.  }%DIFDELCMD < 

%DIFDELCMD < %%%
\DIFdel{It is clear that taking thermal broadening into account means that the
thin velocity slices are not a useful diagnostic, particularly for the lighter chemical elements. Indeed, the inclusion of thermal
...
index and on the structure function index, while the for }\DIFdelend \DIFaddbegin \DIFadd{Figure~\ref{fig:vcatrends} shows the evolution with time of }\DIFaddend the \DIFdelbegin \DIFdel{very thick
velocity slices the 2D power spectrum index depends only on the density spectral index. However, thermal broadening means that the thin slices cannot be interpreted in
such a simple manner. 
}%DIFDELCMD < 
%DIFDELCMD < %%%
\DIFdel{Table~\ref{tab:vca} shows that the slopes of the linear fits to the very
thick velocity slice power spectra do not vary appreciably with time
for the H$\alpha$ }\DIFdelend \DIFaddbegin \DIFadd{VCA
...
variation for }\DIFdelend \DIFaddbegin \gammaVCAvthick{} \DIFadd{are remarkably
stable with time during the latter part of }\DIFaddend the \DIFdelbegin %DIFDELCMD < \nii%%%
\DIFdel{$\lambda$6584 and }%DIFDELCMD < \sii%%%
\DIFdel{$\lambda6716$ lines but
there is no obvious trend with time}\DIFdelend \DIFaddbegin \DIFadd{evolution (\(t >
200,000\)~years).  Although thermal broadening means that there is no
clear distinction between }\gammaVCAthin{} \DIFadd{and }\gammaVCAvthick{} \DIFadd{for
...
turbulence statistics are discussed in \S~\ref{sssec:vca2}}\DIFaddend .
...
\DIFadd{Figure~\ref{fig:vca-thin-vs-n} shows the correlations between the
...
\DIFdelbegin \DIFdel{\(\gamma_{\mathrm{thin}} - \gamma_{\mathrm{vthick}} = 0.08 \pm 0.04\), 
\(0.18 \pm 0.04\), and \(0.18 \pm 0.04\)
}\DIFdelend \DIFaddbegin \DIFadd{\(\gamma_{\mathrm{thin}} - \gamma_{\mathrm{vthick}} = 0.07 \pm 0.05\), 
...
which it is clear that }\DIFaddend only in the case of \oiii{} \DIFdelbegin \DIFdel{do we find this to be the case}\DIFdelend \DIFaddbegin \DIFadd{are the two slopes
equal}\DIFaddend .  In the case of the other lines, \(\gamma_{\mathrm{vthick}}\)
