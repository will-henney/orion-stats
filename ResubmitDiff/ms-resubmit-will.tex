...
\author[S.-N. X. Medina et al.]{S.-N. X. Medina$^{1,2}$, S. J. Arthur$^{2,4}$\thanks{E-mail:
...
The radiation-hydrodynamics code used in the present paper does not
...
spectral index does not change on going from three dimensions to two
...
is the power-law index of the $N$-dimensional second-order structure
...
the power-law fits for a given quantity are essentially constant (see Fig.~\ref{fig:psevol}). Note that here we use
...
%
which corresponds to the slope or gradient in log-log space, 
...
% This behaviour mimics, with a delay of about
% 50,000~yrs, the velocity dispersion behaviour seen in
% Figure~\ref{fig:veldisp}. 
% The flattening-off 
The settling down of the power spectra power-law indices
...
%separated by more than  a sound-crossing time 
are kinematically
...
\bibitem[\protect\citeauthoryear{Ferland et
    al.}{2013}]{2013RMxAA..49..137F} Ferland G.~J., Porter, R. L., van
